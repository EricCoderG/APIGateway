...
type ReverseResponse struct {
	ReversedString string `thrift:"reversedString,1,required" form:"reversedString,required" json:"reversedString,required" query:"reversedString,required"`
}
...
type ReverseServiceReverseStringArgs struct {
	Req *ReverseRequest `thrift:"req,1"`
}
