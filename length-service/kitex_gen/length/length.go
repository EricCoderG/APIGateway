...
func (p *LengthRequest) InitDefault() {
	*p = LengthRequest{}
}
...
func (p *LengthRequest) SetInputString(val string) {
	p.InputString = val
}
...
func (p *LengthRequest) DeepEqual(ano *LengthRequest) bool {
	if p == ano {
		return true
...
func (p *LengthRequest) Field1DeepEqual(src string) bool {
...
type LengthResponse struct {
	Length int32 `thrift:"length,1,required" frugal:"1,required,i32" json:"length"`
}
...
func (p *LengthResponse) InitDefault() {
	*p = LengthResponse{}
}
...
func (p *LengthResponse) SetLength(val int32) {
	p.Length = val
}
...
func (p *LengthResponse) DeepEqual(ano *LengthResponse) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
	}
	if !p.Field1DeepEqual(ano.Length) {
		return false
	}
	return true
}

func (p *LengthResponse) Field1DeepEqual(src int32) bool {
...
type LengthServiceCalculateLengthArgs struct {
	Req *LengthRequest `thrift:"req,1" frugal:"1,default,LengthRequest" json:"req"`
}
...
func (p *LengthServiceCalculateLengthArgs) InitDefault() {
	*p = LengthServiceCalculateLengthArgs{}
}
...
func (p *LengthServiceCalculateLengthArgs) SetReq(val *LengthRequest) {
	p.Req = val
}
...
func (p *LengthServiceCalculateLengthArgs) DeepEqual(ano *LengthServiceCalculateLengthArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *LengthServiceCalculateLengthArgs) Field1DeepEqual(src *LengthRequest) bool {
...
type LengthServiceCalculateLengthResult struct {
	Success *LengthResponse `thrift:"success,0,optional" frugal:"0,optional,LengthResponse" json:"success,omitempty"`
}
...
func (p *LengthServiceCalculateLengthResult) InitDefault() {
	*p = LengthServiceCalculateLengthResult{}
}
...
func (p *LengthServiceCalculateLengthResult) SetSuccess(x interface{}) {
	p.Success = x.(*LengthResponse)
}
...
func (p *LengthServiceCalculateLengthResult) DeepEqual(ano *LengthServiceCalculateLengthResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *LengthServiceCalculateLengthResult) Field0DeepEqual(src *LengthResponse) bool {
